...
enum ops_t {
    ...
    SSA_DIV,  SSA_SUB,  SSA_CMPEQ, SSA_CMPLT, SSA_CMPLE, SSA_CMPNEQ, SSA_CMPNLT, SSA_CMPNLE, 
    SSA_ANDN, SSA_LOAD, SSA_CONST, SSA_STORE, SSA_SQRT,  SSA_RSQRT,  SSA_RCP,    SSA_BLEND
};
